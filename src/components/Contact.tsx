    ...
    <article className='w-9/12 mx-auto'>
      ...
      <form action=''>
        <div className='flex flex-col gap-4'>
          ...
          <button type='submit' className='bg-slate-100 dark:bg-slate-900 dark:text-white py-1 rounded-md focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white'>Enviar</button>
        </div>
      </form>
    </article>
  )
